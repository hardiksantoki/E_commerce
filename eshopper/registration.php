...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5 justify-content-center">
            <div class="col-lg-4 " style="border: solid #d19c97 4px;border-radius: 30px;">
                <div class="mb-4">
                    <form action="php/register.php" method="POST">
                    <h4 class="font-weight-semi-bold mb-4 text-center  "
                        style="background-color: #d19c97;    margin: 0px -15px; padding: 10px;    border-radius: 19px 19px 0px 0px;">
                        Registration</h4>
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input class="form-control" name="pass" type="password" placeholder="example@123">
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 d-flex justify-content-center ">
                            <button type="submit" class="font-weight-bold " style="background-color: #d19c97;   padding: 4px 53px;    border-radius: 30px ;     border: 5px solid #d19c97;     font-size: 24px;">Register</button> 
                        </div>
