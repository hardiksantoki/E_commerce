                    ...
                    <form action="php/register.php" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 d-flex justify-content-center ">
                                <button type="submit" class="font-weight-bold " onclick="return regster()" style="background-color: #d19c97;   padding: 4px 53px;    border-radius: 30px ;     border: 5px solid #d19c97;     font-size: 24px;">Register</button>
                            </div>
