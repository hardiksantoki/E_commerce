...
<head>
    <meta charset="utf-8">
    <title>Covrize Shopping Point</title>
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link" data-toggle="dropdown">Cloths<i class="fa fa-angle-down float-right mt-1"></i></a>
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                <a href="dress_men.php" class="dropdown-item">Men's Cloths</a>
                                <a href="dress_women.php" class="dropdown-item">Women's Cloths</a>
                                <a href="dress_baby.php" class="dropdown-item">Baby's Cloths</a>
                            </div>
                        </div>
                        <a href="mobile.php" class="nav-item nav-link">Mobile</a>
                        <a href="laptop.php" class="nav-item nav-link">Laptop</a>
                        <a href="electronics.php" class="nav-item nav-link">Electronics</a>
                        <a href="accessories.php" class="nav-item nav-link">Accessories</a>
                        <a href="grocery.php" class="nav-item nav-link">Grocery</a>
    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-5 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">Covrize</span>Shopping Point</h1>
                </a>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="" src="img/payments.png" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
