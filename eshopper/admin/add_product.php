...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse" style="background-color: #D19C97;">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="add_product.php" class="nav-item nav-link active">Add Product</a>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5 justify-content-center">
            <div class="col-lg-5 " style="border: solid #d19c97 4px;border-radius: 30px;">
                <div class="mb-4">
                    <form action="../php/admin_add_product.php" method="POST" enctype="multipart/form-data">
                        <h4 class="font-weight-semi-bold mb-4 text-center  " style="background-color: #d19c97;    margin: 0px -15px; padding: 10px;    border-radius: 19px 19px 0px 0px;">
                            Add Product</h4>
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <select class="form-control" name="category" id="">
                                    ...
                                    <option value="6">Man Cloths</option>
                                    <option value="7">Woman Cloths</option>
                                    <option value="8">Child Cloths</option>
                                </select>
                            </div>
                            <div class="col-md-12 d-flex justify-content-center ">
                                <button type="submit" class="font-weight-bold " style="background-color: #d19c97;   padding: 4px 53px;    border-radius: 30px ;     border: 5px solid #d19c97;     font-size: 24px;">Add</button>
                            </div>
